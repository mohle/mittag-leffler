// Filename: ml_v1.cpp
// Version:  Standalone C++ Version 1.0
// Date:     May 10, 2022
//
...
//
// Please compile this file using the command "g++ ml_v1.cpp -o ml.exe"
// or "g++ ml_v1.cpp -std=c++11 -o ml.exe".
//
...
// 978-1006 (2021).
//
// In contrast to the standalone ANSI C Version "mitlef_v1.c" this C++
// program "ml_v1.cpp" uses the C++11 random number generation component
